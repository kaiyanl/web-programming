...
var FlipBtn = function (_React$Component5) {
  _inherits(FlipBtn, _React$Component5);

  function FlipBtn() {
    _classCallCheck(this, FlipBtn);

    return _possibleConstructorReturn(this, (FlipBtn.__proto__ || Object.getPrototypeOf(FlipBtn)).apply(this, arguments));
  }

  _createClass(FlipBtn, [{
    key: 'render',
    value: function render(props) {
      return React.createElement(
        'div',
...
var Card = function (_React$Component6) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'card-container', onClick: flip },
        React.createElement(
          'div',
          { className: 'card-body' },
